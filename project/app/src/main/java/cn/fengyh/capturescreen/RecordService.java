...
public class RecordService extends Service
{
    ...
    {
        mVideoPath = Environment.getExternalStorageDirectory().getPath() + "/CaptureScreen/";
    ...
    private void createFloatView()
    {
        ...
        mCaptureLayout = (LinearLayout) inflater.inflate(R.layout.float_record, null);
        final ImageView mCaptureImageView = (ImageView) mCaptureLayout.findViewById(R.id.iv_record);
        ...
        mCaptureImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) 
			{
                ...
                if (isRecordOn)
                {
                    mCaptureImageView.setImageResource(R.mipmap.ic_recording);
                    Toast.makeText(RecordService.this.getApplicationContext(), "开始录屏", Toast.LENGTH_SHORT).show();
                    recordStart();
                }
                else
                {
                    mCaptureImageView.setImageResource(R.mipmap.ic_record);
    ...
    private void startRecord()
    {
        try
        {
            mMediaMuxer = new MediaMuxer(mVideoPath + System.currentTimeMillis() + ".mp4", MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
